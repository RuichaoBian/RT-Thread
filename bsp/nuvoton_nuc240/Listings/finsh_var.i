#line 1 "..\\..\\components\\finsh\\finsh_var.c"
...
#line 32 "..\\..\\components\\finsh\\finsh_var.c"
...
#line 33 "..\\..\\components\\finsh\\finsh_var.c"

struct finsh_var global_variable[8];
...
int finsh_var_insert(const char* name, int type)
{
	...
	for (i = 0; i < 8; i ++)
	{
		...
		if (strncmp(global_variable[i].name, name, 16) == 0)
			return -1;
	...
	strncpy(global_variable[empty].name, name, 16);
