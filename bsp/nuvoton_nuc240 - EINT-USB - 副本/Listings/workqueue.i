#line 1 "..\\..\\components\\drivers\\src\\workqueue.c"
...
#line 26 "..\\..\\components\\drivers\\src\\workqueue.c"
#line 27 "..\\..\\components\\drivers\\src\\workqueue.c"
...
#line 28 "..\\..\\components\\drivers\\src\\workqueue.c"
...
rt_err_t rt_workqueue_destroy(struct rt_workqueue* queue)
{
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 91); };
...
{
    rt_base_t level;
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 102); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 103); };
...
{
    rt_base_t level;
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 132); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 133); };
...
rt_err_t rt_workqueue_cancel_work(struct rt_workqueue* queue, struct rt_work* work)
{
    ...
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 162); };
    if (!(work != (0))) { rt_assert_handler("work != RT_NULL", __FUNCTION__, 163); };
...
rt_err_t rt_workqueue_cancel_all_work(struct rt_workqueue* queue)
{
    ...
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 180); };
