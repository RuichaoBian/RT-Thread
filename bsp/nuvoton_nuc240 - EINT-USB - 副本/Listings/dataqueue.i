#line 1 "..\\..\\components\\drivers\\src\\dataqueue.c"
...
#line 27 "..\\..\\components\\drivers\\src\\dataqueue.c"
...
#line 28 "..\\..\\components\\drivers\\src\\dataqueue.c"
...
#line 29 "..\\..\\components\\drivers\\src\\dataqueue.c"
...
rt_data_queue_init(struct rt_data_queue *queue,
                   ...
                   void (*evt_notify)(struct rt_data_queue *queue, rt_uint32_t event))
{
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 42); };
                            ...
                            rt_int32_t timeout)
{
    ...
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 74); };
                           ...
                           rt_int32_t timeout)
{
    ...
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 163); };
    if (!(data_ptr != (0))) { rt_assert_handler("data_ptr != RT_NULL", __FUNCTION__, 164); };
    if (!(size != (0))) { rt_assert_handler("size != RT_NULL", __FUNCTION__, 165); };
    ...
    while (queue->get_index == queue->put_index)
    {
        ...
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 181); } } rt_hw_interrupt_enable(level); } while (0);
                            ...
                            rt_size_t *size)
{
    ...
    if (!(queue != (0))) { rt_assert_handler("queue != RT_NULL", __FUNCTION__, 262); };
