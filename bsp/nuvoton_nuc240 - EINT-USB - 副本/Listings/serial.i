#line 1 "..\\..\\components\\drivers\\serial\\serial.c"
...
#line 38 "..\\..\\components\\drivers\\serial\\serial.c"
#line 39 "..\\..\\components\\drivers\\serial\\serial.c"
...
{
    if (!(pipe != (0))) { rt_assert_handler("pipe != RT_NULL", __FUNCTION__, 238); };
...
#line 40 "..\\..\\components\\drivers\\serial\\serial.c"
...
static void rt_dma_recv_update_get_index(struct rt_serial_device *serial, rt_size_t len)
{
    ...
    if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 198); };
    if (!(len <= rt_dma_calc_recved_len(serial))) { rt_assert_handler("len <= rt_dma_calc_recved_len(serial)", __FUNCTION__, 199); };
...
static void rt_dma_recv_update_put_index(struct rt_serial_device *serial, rt_size_t len)
{
    ...
    if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 220); };
...
static __inline int _serial_dma_rx(struct rt_serial_device *serial, rt_uint8_t *data, int length)
{
    ...
    if (!((serial != (0)) && (data != (0)))) { rt_assert_handler("(serial != RT_NULL) && (data != RT_NULL)", __FUNCTION__, 262); };
    ...
    if (serial->config.bufsz == 0)
    {
        ...
        if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 272); };

        if (rx_dma->activated != 1)
        {
            rx_dma->activated = 1;
            if (!(serial->ops->dma_transmit != (0))) { rt_assert_handler("serial->ops->dma_transmit != RT_NULL", __FUNCTION__, 277); };
    ...
    else
    {
        ...
        if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 293); };
...
static rt_err_t rt_serial_open(struct rt_device *dev, rt_uint16_t oflag)
{
    ...
    if (serial->serial_rx == (0))
    {
        if (oflag & 0x200)
        {
            if (serial->config.bufsz == 0) {
                ...
                if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 401); };
                rx_dma->activated = 0;
                ...
                rx_fifo = (struct rt_serial_rx_fifo*) rt_malloc (sizeof(struct rt_serial_rx_fifo) +
                    serial->config.bufsz);
                if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 410); };
        ...
        else if (oflag & 0x100)
        {
            ...
            rx_fifo = (struct rt_serial_rx_fifo*) rt_malloc (sizeof(struct rt_serial_rx_fifo) +
                serial->config.bufsz);
            if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 428); };
            rx_fifo->buffer = (rt_uint8_t*) (rx_fifo + 1);
            rt_memset(rx_fifo->buffer, 0, serial->config.bufsz);
            rx_fifo->put_index = 0;
            rx_fifo->get_index = 0;
    ...
    if (serial->serial_tx == (0))
    {
        if (oflag & 0x800)
        {
            ...
            if (!(tx_dma != (0))) { rt_assert_handler("tx_dma != RT_NULL", __FUNCTION__, 452); };
            tx_dma->activated = 0;
        ...
        else if (oflag & 0x400)
        {
            ...
            if (!(tx_fifo != (0))) { rt_assert_handler("tx_fifo != RT_NULL", __FUNCTION__, 465); };
...
static rt_err_t rt_serial_close(struct rt_device *dev)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 487); };
    serial = (struct rt_serial_device *)dev;
    ...
    if (dev->open_flag & 0x100)
    {
        ...
        rx_fifo = (struct rt_serial_rx_fifo*)serial->serial_rx;
        if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 498); };
    ...
    else if (dev->open_flag & 0x200)
    {
        if (serial->config.bufsz == 0) {
            ...
            rx_dma = (struct rt_serial_rx_dma*)serial->serial_rx;
            if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 512); };
            ...
            rx_fifo = (struct rt_serial_rx_fifo*)serial->serial_rx;
            if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 519); };
    ...
    if (dev->open_flag & 0x400)
    {
        ...
        if (!(tx_fifo != (0))) { rt_assert_handler("tx_fifo != RT_NULL", __FUNCTION__, 534); };
    ...
    else if (dev->open_flag & 0x800)
    {
        ...
        tx_dma = (struct rt_serial_tx_dma*)serial->serial_tx;
        if (!(tx_dma != (0))) { rt_assert_handler("tx_dma != RT_NULL", __FUNCTION__, 547); };
                                ...
                                rt_size_t         size)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 564); };
    if (size == 0) return 0;
                                 ...
                                 rt_size_t         size)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 588); };
    if (size == 0) return 0;
                                  ...
                                  void             *args)
{
    ...
    if (!(dev != (0))) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 613); };
    serial = (struct rt_serial_device *)dev;
                               ...
                               void                    *data)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 666); };
...
void rt_hw_serial_isr(struct rt_serial_device *serial, int event)
{
    switch (event & 0xff)
    {
        case 0x01:
        {
            ...
            rx_fifo = (struct rt_serial_rx_fifo*)serial->serial_rx;
            if (!(rx_fifo != (0))) { rt_assert_handler("rx_fifo != RT_NULL", __FUNCTION__, 699); };
        ...
        case 0x03:
        {
            ...
            if (serial->config.bufsz == 0)
            {
                ...
                rx_dma = (struct rt_serial_rx_dma*) serial->serial_rx;
                if (!(rx_dma != (0))) { rt_assert_handler("rx_dma != RT_NULL", __FUNCTION__, 789); };

                if (!(serial->parent . rx_indicate != (0))) { rt_assert_handler("serial->parent.rx_indicate != RT_NULL", __FUNCTION__, 791); };
