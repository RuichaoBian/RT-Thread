#line 1 "..\\..\\components\\finsh\\shell.c"
...
#line 40 "..\\..\\components\\finsh\\shell.c"
...
#line 42 "..\\..\\components\\finsh\\shell.c"
...
#line 43 "..\\..\\components\\finsh\\shell.c"
...
static char finsh_thread_stack[512];
struct finsh_shell *shell;

#line 84 "..\\..\\components\\finsh\\shell.c"

static rt_err_t finsh_rx_ind(rt_device_t dev, rt_size_t size)
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 87); };
...
void finsh_set_device(const char *device_name)
{
    ...
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 106); };
    ...
    if (rt_device_open(dev, 0x003 | 0x100 |                        0x040) == 0)
...
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 145); };
...
void finsh_set_echo(rt_uint32_t echo)
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 160); };
...
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 173); };

    return shell->echo_mode;
}

#line 264 "..\\..\\components\\finsh\\shell.c"

static void shell_auto_complete(char *prefix)
{

    rt_kprintf("\n");
#line 276 "..\\..\\components\\finsh\\shell.c"
    {
...
#line 382 "..\\..\\components\\finsh\\shell.c"
...
void finsh_thread_entry(void *parameter)
{
    ...
    if (shell->device == (0))
    {
        ...
        if (!(shell->device)) { rt_assert_handler("shell->device", __FUNCTION__, 402); };
        rt_device_set_rx_indicate(shell->device, finsh_rx_ind);
        rt_device_open(shell->device, (0x003 | 0x040 | 0x100));



    }

#line 417 "..\\..\\components\\finsh\\shell.c"
    ...
    while (1)
    {
        ...
        if (rt_sem_take(&shell->rx_sem, -1) != 0) continue;
        ...
        while (rt_device_read(shell->device, 0, &ch, 1) == 1)
        {
            ...
            else if (shell->stat == WAIT_FUNC_KEY)
            {
                ...
                if (ch == 0x41)  
                {
#line 472 "..\\..\\components\\finsh\\shell.c"
                    continue;
                }
                else if (ch == 0x42)  
                {
#line 494 "..\\..\\components\\finsh\\shell.c"
                    continue;
                }
                else if (ch == 0x44)  
                {
...
#line 596 "..\\..\\components\\finsh\\shell.c"
                {
...
#line 698 "..\\..\\components\\finsh\\shell.c"
...
#line 748 "..\\..\\components\\finsh\\shell.c"
...
const init_fn_t __rt_init_finsh_system_init __attribute__((section(".rti_fn." "3"))) = finsh_system_init;
