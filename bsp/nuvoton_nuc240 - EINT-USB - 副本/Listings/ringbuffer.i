...
void rt_ringbuffer_init(struct rt_ringbuffer *rb,
                        ...
                        rt_int16_t            size)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 34); };
    if (!(size > 0)) { rt_assert_handler("size > 0", __FUNCTION__, 35); }
                            ...
                            rt_uint16_t           length)
{
    ...
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 56); };
                            ...
                            rt_uint16_t           length)
{
    ...
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 105); };
                            ...
                            rt_uint16_t           length)
{
    ...
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 156); };
...
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 199); };
...
rt_size_t rt_ringbuffer_putchar_force(struct rt_ringbuffer *rb, const rt_uint8_t ch)
{
    ...
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 231); };
...
rt_size_t rt_ringbuffer_getchar(struct rt_ringbuffer *rb, rt_uint8_t *ch)
{
    if (!(rb != (0))) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 264); };
