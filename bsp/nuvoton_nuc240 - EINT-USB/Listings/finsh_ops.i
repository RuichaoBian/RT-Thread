#line 1 "..\\..\\components\\finsh\\finsh_ops.c"
...
#line 30 "..\\..\\components\\finsh\\finsh_ops.c"
#line 31 "..\\..\\components\\finsh\\finsh_ops.c"
...
void OP_add_byte()
{
    do { (finsh_sp - 2)->char_value = (finsh_sp - 2)->char_value + (finsh_sp - 1)->char_value; finsh_sp--; }while (0);
...
void OP_add_word()
{
    do { (finsh_sp - 2)->short_value = (finsh_sp - 2)->short_value + (finsh_sp - 1)->short_value; finsh_sp--; }while (0);
...
void OP_add_dword()
{
    do { (finsh_sp - 2)->long_value = (finsh_sp - 2)->long_value + (finsh_sp - 1)->long_value; finsh_sp--; }while (0);
...
void OP_ld_word()
{
	finsh_sp->short_value = (*(finsh_pc)) | (*((finsh_pc)+1) << 8);
...
void OP_ld_dword()
{
	finsh_sp->long_value = (rt_uint32_t)(*(finsh_pc)) | ((rt_uint32_t)*((finsh_pc)+1) << 8) | ((rt_uint32_t)*((finsh_pc)+2) << 16) | ((rt_uint32_t)*((finsh_pc)+3) << 24);
...
void OP_ld_value_byte()
{
	...
	c = (char*) ((rt_uint32_t)(*(finsh_pc)) | ((rt_uint32_t)*((finsh_pc)+1) << 8) | ((rt_uint32_t)*((finsh_pc)+2) << 16) | ((rt_uint32_t)*((finsh_pc)+3) << 24));
...
void OP_ld_value_word()
{
	...
	s = (short*) ((rt_uint32_t)(*(finsh_pc)) | ((rt_uint32_t)*((finsh_pc)+1) << 8) | ((rt_uint32_t)*((finsh_pc)+2) << 16) | ((rt_uint32_t)*((finsh_pc)+3) << 24));
...
void OP_ld_value_dword()
{
	...
	l = (long*) ((rt_uint32_t)(*(finsh_pc)) | ((rt_uint32_t)*((finsh_pc)+1) << 8) | ((rt_uint32_t)*((finsh_pc)+2) << 16) | ((rt_uint32_t)*((finsh_pc)+3) << 24));
