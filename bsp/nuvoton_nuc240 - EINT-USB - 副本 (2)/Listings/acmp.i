#line 1 "Libraries\\StdDriver\\src\\acmp.c"
...
#line 13 "Libraries\\StdDriver\\src\\acmp.c"
...
{
    Acmp->CMPCR[u32ChNum] = (Acmp->CMPCR[u32ChNum] & (~((1ul << 4) | (1ul << 2)))) | (u32NegSrc | u32HysteresisEn | (1ul << 0));
}
