...
#line 13 "Libraries\\StdDriver\\src\\i2s.c"
...
#line 14 "Libraries\\StdDriver\\src\\i2s.c"
...
static uint32_t I2S_GetSourceClockFreq(I2S_T *i2s)
{
    ...
    u32ClkSrcSel = ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (3ul << 0);
...
uint32_t I2S_Open(I2S_T *i2s, uint32_t u32MasterSlave, uint32_t u32SampleRate, uint32_t u32WordWidth, uint32_t u32Channels, uint32_t u32DataFormat)
{
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (1ul << 29);
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(1ul << 29);

     
    i2s->CON = u32MasterSlave | u32WordWidth | u32Channels | u32DataFormat | (4 << 9) | (3 << 12);
...
uint32_t I2S_EnableMCLK(I2S_T *i2s, uint32_t u32BusClock)
{
    ...
    i2s->CLKDIV = (i2s->CLKDIV & ~(7ul << 0)) | u8Divider;

    i2s->CON |= (1ul << 15);

    u32Reg = i2s->CLKDIV & (7ul << 0);
