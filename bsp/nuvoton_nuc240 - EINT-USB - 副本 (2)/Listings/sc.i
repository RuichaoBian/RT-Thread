...
#line 12 "Libraries\\StdDriver\\src\\sc.c"
...
uint32_t SC_IsCardInserted(SC_T *sc)
{
    ...
    uint32_t cond1 = ((sc->PINCSR & (1ul << 4)) >> 4);
    uint32_t cond2 = ((sc->PINCSR & (1ul << 10)) >> 10);

    if(sc == ((SC_T *) ((( uint32_t)0x40100000) + 0x90000)) && u32CardStateIgnore[0] == 1)
        return 1;
    else if(sc == ((SC_T *) ((( uint32_t)0x40100000) + 0x94000)) && u32CardStateIgnore[1] == 1)
        return 1;
    else if(sc == ((SC_T *) ((( uint32_t)0x40100000) + 0x98000)) && u32CardStateIgnore[2] == 1)
        return 1;
    else if(cond1 != cond2)
        return 0;
    else
...
void SC_Open(SC_T *sc, uint32_t u32CD, uint32_t u32PWR)
{
    ...
    while(sc->PINCSR & (1ul << 30));
    u32Reg |= u32PWR ? 0 : (1ul << 11);
    sc->PINCSR = u32Reg;
    sc->CTL = (1ul << 0);
}
...
void SC_ResetReader(SC_T *sc)
{
    ...
    while(sc->CTL & (1ul << 30));
    sc->CTL &= ~((3ul << 6) | (3ul << 24) | (7ul << 20) | (7ul << 16));
