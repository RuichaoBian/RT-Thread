...
#line 8 "Drivers\\usart.h"
#line 9 "Drivers\\usart.h"
...
static rt_err_t nuc240_configure(struct rt_serial_device *serial,struct serial_configure *cfg)
{
    ...
    UART_Open(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)), cfg->baud_rate);
...
static rt_err_t nuc240_control(struct rt_serial_device *serial,int cmd,void *arg){
	...
	switch(cmd)
	{
		case 0x11:{
			...
			UART_DisableInt(uart,(1ul << 0));
			break;
		}
		case 0x10:{
			UART_EnableInt(uart,(1ul << 0));
			break;
		}
	}
	return 0;
...
static int nuc240_putc(struct rt_serial_device *serial, char c)
{
    UART_T* uart;
    uart = (UART_T *)serial->parent.user_data;
    if ((((uart)->FSR & (1ul << 23))>>23)) {
        while(!((((uart)->FSR) & (1ul << 28)) >> 28));
...
void UART02_IRQHandler(void)
{
    ...
    rt_interrupt_enter();
		UART_ClearIntFlag(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)) , (1ul << 0));
...
void rt_hw_usart_init(void)
{
    ...
    rt_hw_serial_register(&serial0, "uart0",
                          0x003 | 0x100,
                          ((UART_T *) ((( uint32_t)0x40000000) + 0x50000)));
