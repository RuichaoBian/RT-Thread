...
const uint8_t gu8ConfigDescriptor[] =
{
    ...
    (9+9*2+9*2+7*2) & 0x00FF,
    ((9+9*2+9*2+7*2) & 0xFF00) >> 8,
    0x02,            
    0x01,            
    0x00,            
    0x80 | (0 << 6) | (0 << 5), 
...
{
    (9+9),
    (sizeof(gu8ConfigDescriptor) - 9 - 7),
    0
};
