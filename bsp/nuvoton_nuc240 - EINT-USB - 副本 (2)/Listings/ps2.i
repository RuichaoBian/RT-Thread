...
#line 13 "Libraries\\StdDriver\\src\\ps2.c"
...
#line 14 "Libraries\\StdDriver\\src\\ps2.c"

 
 
 
#line 19 "Libraries\\StdDriver\\src\\ps2.c"
...
void PS2_EnableInt(uint32_t u32Mask)
{
    ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON |= u32Mask;
}
...
void PS2_Open(void)
{
    ...
    ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON |= (1ul << 0);

     
    ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON &= ~(0xFul << 3);
...
uint8_t PS2_Read(void)
{
    return (uint8_t)(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2RXDATA & (0xFFul << 0));
}
...
int32_t PS2_Write(uint32_t *pu32Buf, uint32_t u32ByteCount)
{
    ...
    u32delayno = 0;
    while(!(((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2STATUS & (1ul << 7)))
    {
        u32delayno++;
    ...
    if(u32ByteCount >= u32TxFIFO_Depth)
        (((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON = (((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON & ~(0xFul << 3)) | (((u32TxFIFO_Depth)-1) << 3));
    ...
    do
    {
        ...
        if((txcnt == 1) && (remainder != 0))
            (((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON = (((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2CON & ~(0xFul << 3)) | (((u32ByteCount)-1) << 3));

        ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2TXDATA0 = pu32Buf[i];
        ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2TXDATA1 = pu32Buf[i + 1];
        ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2TXDATA2 = pu32Buf[i + 2];
        ((PS2_T *) ((( uint32_t)0x40100000) + 0x00000))->PS2TXDATA3 = pu32Buf[i + 3];
